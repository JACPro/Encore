...
public class GoalMouseHover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    [SerializeField]
    GameObject tooltip;
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        tooltip.GetComponentInChildren<TextMeshProUGUI>().text = goalManager.activeGoals[Int32.Parse(name)].description;
